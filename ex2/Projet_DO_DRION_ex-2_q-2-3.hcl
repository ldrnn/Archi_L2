...
intsig ALUSUB                   'alufct.A_SUB'          # ALU should subtract its arguments
...
bool need_regids =
    icode in { RRMOVL, OPL, IOPL, PUSHL, POPL, IRMOVL, RMMOVL, MRMOVL, INCL };
...
bool instr_valid =
    icode in { NOP, HALT, RRMOVL, IRMOVL, RMMOVL, MRMOVL,
               OPL, IOPL, JXX, CALL, RET, PUSHL, POPL, INCL } ;

## Decode stage ####################################################

## What register should be used as the A source?
int srcA = [
    icode in { RRMOVL, RMMOVL, OPL, PUSHL, INCL } : rA;
